# Module Validation: Dropbox (sanctioned use, noise reduction)

**Module**: sysmon-configs/modules/cloud-storage/exclude_dropbox.xml
**Version**: v1.1
...
Source: Public vendor documentation for the Dropbox desktop client; common deployment knowledge; observed binary names from community Sysmon configurations.
