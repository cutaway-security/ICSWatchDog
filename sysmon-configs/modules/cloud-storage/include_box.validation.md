# Module Validation: Box (unsanctioned, detection)

**Module**: sysmon-configs/modules/cloud-storage/include_box.xml
**Version**: v1.1
...
Source: Public vendor documentation for the Box desktop client; common deployment knowledge; observed binary names from community Sysmon configurations.
