# Module Validation: MEGA (detection only, generally not sanctioned)

**Module**: sysmon-configs/modules/cloud-storage/include_mega.xml
**Version**: v1.1
...
Source: Public vendor documentation for the MEGA.nz desktop client; common deployment knowledge; observed binary names from community Sysmon configurations.
