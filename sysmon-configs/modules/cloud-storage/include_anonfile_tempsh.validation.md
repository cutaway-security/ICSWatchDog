# Module Validation: Anonymous File Sharing (detection only)

**Module**: sysmon-configs/modules/cloud-storage/include_anonfile_tempsh.xml
**Version**: v1.1
...
Source: Public vendor documentation for the anonymous file sharing services; common deployment knowledge; observed binary names from community Sysmon configurations.
