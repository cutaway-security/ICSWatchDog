# Module Validation: Microsoft OneDrive (sanctioned use, noise reduction)

**Module**: sysmon-configs/modules/cloud-storage/exclude_onedrive.xml
**Version**: v1.1
...
Source: Public vendor documentation for the Microsoft OneDrive desktop client; common deployment knowledge; observed binary names from community Sysmon configurations.
