# Module Validation: AVEVA / OSIsoft PI System

**Module**: sysmon-configs/modules/vendor-ot/aveva-pi-system.xml
**Version**: v1.1
...
Source: AVEVA / OSIsoft PI Server documentation (PI Data Archive, PI AF, PI System Management Tools); vendor install guides.
