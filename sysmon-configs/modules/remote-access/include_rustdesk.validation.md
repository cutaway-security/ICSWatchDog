# Module Validation: RustDesk (unsanctioned, detection)

**Module**: sysmon-configs/modules/remote-access/include_rustdesk.xml
**Version**: v1.1
...
Source: RustDesk vendor public documentation; LOLRMM project (lolrmm.io); CISA AA23-025A RMM advisory; community Sysmon configurations.
