# Module Validation: TeamViewer (sanctioned, noise reduction)

**Module**: sysmon-configs/modules/remote-access/exclude_teamviewer.xml
**Version**: v1.1
...
Source: TeamViewer vendor public documentation; LOLRMM project (lolrmm.io); CISA AA23-025A RMM advisory; community Sysmon configurations.
