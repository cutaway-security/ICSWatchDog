# Module Validation: AnyDesk (unsanctioned, detection)

**Module**: sysmon-configs/modules/remote-access/include_anydesk.xml
**Version**: v1.1
...
Source: AnyDesk vendor public documentation; LOLRMM project (lolrmm.io); CISA AA23-025A RMM advisory; community Sysmon configurations.
