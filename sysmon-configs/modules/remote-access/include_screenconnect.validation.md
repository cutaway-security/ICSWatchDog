# Module Validation: ConnectWise ScreenConnect / ConnectWise Control (unsanctioned)

**Module**: sysmon-configs/modules/remote-access/include_screenconnect.xml
**Version**: v1.1
...
Source: ConnectWise ScreenConnect vendor public documentation; LOLRMM project (lolrmm.io); CISA AA23-025A RMM advisory; community Sysmon configurations.
