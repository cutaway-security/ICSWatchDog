# Module Validation: Electric Utility

**Module**: sysmon-configs/modules/sector/electric-utility.xml
**Version**: v1.1
**Confidence**: vendor-documented (vendor tools); security-research (sector grouping)
**Last Validated**: 2026-04-11
**Validated By**: ICS Watch Dog Project (initial assessment)

## Evidence

Source: SEL public documentation for AcSELerator/QuickSet; ABB Microscada documentation; IEC 61850 standard; CISA advisories for electric sector.
