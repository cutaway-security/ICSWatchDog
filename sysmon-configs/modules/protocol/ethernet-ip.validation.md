# Module Validation: EtherNet/IP (Allen-Bradley / Rockwell)

**Module**: sysmon-configs/modules/protocol/ethernet-ip.xml
**Version**: v1.1
...
Source: IANA service name and port number registry; IEC and ISO standards documents; protocol vendor specifications.
