# Module Validation: Microsoft Edge (noise reduction)

**Module**: sysmon-configs/modules/vendor-it/exclude_microsoft_edge.xml
**Version**: v1.1
...
Source: Microsoft Edge default install paths from vendor documentation; common deployment knowledge.
