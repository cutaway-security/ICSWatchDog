# Module Validation: Microsoft Office (noise reduction)

**Module**: sysmon-configs/modules/vendor-it/exclude_microsoft_office.xml
**Version**: v1.1
...
Source: Microsoft Office default install paths from vendor documentation; common deployment knowledge.
