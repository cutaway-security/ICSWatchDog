# Module Validation: Google Chrome (noise reduction)

**Module**: sysmon-configs/modules/vendor-it/exclude_google_chrome.xml
**Version**: v1.1
...
Source: Google Chrome default install paths from vendor documentation; common deployment knowledge.
